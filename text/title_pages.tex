...
\noindent Abstract: 
The topic of this thesis is to implement an efficient decoder for the speech recognition 
...
which minimizes latency and optimizes speed. Methods used for speeding up the~decoder are not 
limited to multi-threading decoding or usage of~GPU cards for general computations. 
Part of~this work is devoted to training an acoustic model and testing it in the~"Vystadial" dialogue system.
